...
@section('auth-main')
  <div class="flex flex-col flex-1 w-full lg:w-1/2">
    ...
    <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
      ...
      <x-dynamic-form :action="route('signup.submit')" method="POST" :fields="$signupFields" :columns="2" :show-submit="false" class="space-y-5">
        <div class="text-sm text-gray-500 dark:text-gray-400">
          <label class="inline-flex items-start gap-2 cursor-pointer">
            <input type="checkbox" required class="mt-1 h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500/30" />
            <span>
