...
@section('content')
  @php
    $socialLinks = [
      'Facebook' => 'https://facebook.com/PimjoHQ',
      'X.com' => 'https://x.com/PimjoHQ',
          ...
          <div class="flex w-full flex-col items-center gap-6 xl:flex-row">
            ...
            <div class="order-3 xl:order-2">
              ...
              <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                <x-ui.badge variant="primary">{{ $profile['role'] }}</x-ui.badge>
            ...
            <div class="order-2 flex grow items-center gap-2 xl:order-3 xl:justify-end">
              @foreach($profile['socials'] as $social)
                <button type="button" class="flex h-11 w-11 items-center justify-center rounded-full border border-gray-300 bg-white text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                  @if($social === 'facebook')
  ...
  <x-ui.modal name="profile-info-modal" maxWidth="3xl">
    <div class="relative rounded-3xl bg-white p-6 dark:bg-[#101A33] lg:p-10">
      <button
        ...
        class="absolute right-5 top-5 flex h-11 w-11 items-center justify-center rounded-full bg-gray-100 text-gray-500 hover:bg-gray-200 hover:text-gray-700 dark:bg-white/[0.05] dark:text-gray-400 dark:hover:bg-white/[0.07] dark:hover:text-gray-200"
      >
      ...
      <form class="flex flex-col">
        <div class="custom-scrollbar max-h-[450px] overflow-y-auto pr-2">
          <div>
  ...
  <x-ui.modal name="profile-address-modal" maxWidth="3xl">
    <div class="relative rounded-3xl bg-white p-6 dark:bg-[#101A33] lg:p-10">
      ...
      <form class="flex flex-col">
        <div class="custom-scrollbar max-h-[300px] overflow-y-auto pr-2">
          <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
            @foreach($address as $label => $value)
              <div>
                <x-ui.label class="dark:text-gray-400">{{ $label }}</x-ui.label>
